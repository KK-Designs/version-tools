...
/**
 * @example import { majorVer } from 'major-version-check';
 ...
 * @returns {boolean}
*/
export function majorVer(oldVersion, newVersion, options) {
...
/**
 * @since 1.3.0
 * @example import { parseVersion } from 'major-version-check';
...
*/
export function parseVersion(version, options) {
...
/**
 * @since 1.4.0
 * @example import { compare } from 'major-version-check';
...
export function compare(version, compare, options) {
	const types = [
		'equal',
		'lessThan',
		'greaterThan',
